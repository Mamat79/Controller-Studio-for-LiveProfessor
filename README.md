...
Le but n’est pas de remplacer LiveProfessor ni son système de Controller Maps.

Au contraire, le bridge utilise les fonctions prévues par LiveProfessor pour permettre à l’EC4 de devenir une surface de contrôle beaucoup plus lisible et agréable à utiliser.
...
On crée une fois une map pour un type de plugin.
...
Deux types d’affichage sont utilisés :
...
A map can be created once for a plugin type.
