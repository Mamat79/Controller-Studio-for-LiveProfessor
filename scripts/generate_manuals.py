        ...
        "sections": [
            ...
            (
                ...
                [
                    ...
                    (
                        "p",
                        "Deux cases indépendantes sont disponibles sur la page Live et dans Options. Sous Windows, Controller Studio peut démarrer dans la zone de notification ; sous macOS, il peut démarrer à l'ouverture de session et rester réduit dans le Dock. Démarrer automatiquement la connexion du contrôleur sélectionné lance ensuite le moteur sans clic manuel. Si le système n'a pas encore rendu les ports MIDI disponibles, Controller Studio réessaie silencieusement plusieurs fois.",
                    ),
                    ("h2", "Langue, zone de notification et Dock"),
                    (
                        "p",
                        "Options > Langue bascule immédiatement entre français et anglais. La réduction dans la zone de notification Windows ou le Dock macOS masque la fenêtre sans arrêter un moteur actif ; Quitter arrête réellement l'application.",
                    ),
                    ("h2", "Notice, mises à jour et soutien"),
                    (
                        "p",
                        "Le menu Aide ouvre la notice dans la langue active et recherche les versions stables. Il choisit automatiquement l'installateur Windows ou le DMG Intel/Apple Silicon approprié, puis contrôle sa taille et son empreinte SHA-256 avant ouverture.",
                    ),
                    (
                        "support",
        ...
        "sections": [
            ...
            (
                ...
                [
                    ...
                    ("p", "Two independent checkboxes are available on the Live page and under Options. On Windows, Controller Studio can start in the notification area; on macOS, it can launch at login and remain minimized in the Dock. Connect the selected controller automatically then starts the engine without a manual click. If the operating system has not exposed the MIDI ports yet, Controller Studio retries silently several times."),
                    ("h2", "Language, notification area, and Dock"),
                    ("p", "Options > Language switches immediately between French and English. Minimizing to the Windows notification area or the macOS Dock hides the window without stopping an active engine; Quit actually stops the application."),
                    ("h2", "Manual, updates, and support"),
                    ("p", "Help opens the manual in the active language and checks stable releases. It automatically chooses the Windows installer or the matching Intel/Apple Silicon DMG, then verifies its size and SHA-256 before opening it."),
