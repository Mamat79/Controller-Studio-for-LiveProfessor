        ...
        (
            ...
            [
                ...
                *_bullets([
                ...
                _p("Les paramètres suivent l'ordre technique exposé par le plugin. L'outil ne peut pas inventer un paramètre absent de LiveProfessor ni décider seul de son importance musicale."),
            ],
        ),
        (
