        ...
        (
            ...
            [
                ...
                *_bullets([
                ...
                _p("AutoMap réutilise d'abord les affectations actives et les presets manuels, puis applique un profil unique à toutes les instances d'un même type de plugin. Les fonctions manuelles complémentaires utilisent les rotatifs encore libres, dans la limite de la banque ; une fonction déjà présente n'est pas remappée ailleurs. Seul le couple poussoir N + rotatif N peut partager le même paramètre afin que le label du poussoir reste visible avant l'appui."),
